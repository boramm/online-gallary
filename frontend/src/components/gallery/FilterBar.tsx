...
import { Search, TrendingUp, Clock, Eye, X, Check } from "lucide-react";
    ...
    >
      <div className="container mx-auto max-w-6xl space-y-3 md:space-y-4">
          ...
          {departmentsWithColors.map((dept) => {
            ...
            return (
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className={`shrink-0 px-3 py-1.5 md:px-4 md:py-2 rounded-full font-medium transition-all text-sm md:text-base whitespace-nowrap ${
        ...
        <div className="flex flex-col md:flex-row gap-3 md:gap-4 px-4 md:px-0">
          ...
          {/* 정렬 토글 - iOS 스타일 */}
          <div className="flex gap-1 glass backdrop-blur-xl rounded-2xl p-2 relative">
            {/* 슬라이딩 배경 */}
            <motion.div
